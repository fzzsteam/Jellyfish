...
export const TASK_COPY = {
  chapterDivision: {
    title: '分镜提取与自动准备',
    runningDescription: '系统正在后台提取分镜，并自动准备每个镜头的资产与对白。',
    cancellingDescription: '已发送取消请求，系统会在当前步骤结束后停止。',
    successDescription: '分镜提取与自动准备已完成，页面内容已自动刷新。',
    cancelledDescription: '分镜提取与自动准备已取消。',
    failedDescription: '分镜提取与自动准备失败，请稍后重试。',
    startedMessage: '已开始分镜提取与自动准备',
    reusedMessage: '已恢复当前章节的分镜提取与自动准备任务',
    cancelledImmediatelyMessage: '分镜提取与自动准备已取消',
    cancelRequestedMessage: '已请求取消分镜提取与自动准备',
    runningMessage: '当前已有分镜提取与自动准备任务在运行',
    cancellingMessage: '当前分镜提取与自动准备任务正在取消，请稍候',
  },
  scriptExtract: {
    title: '准备结果刷新',
    runningDescription: '任务完成后会重新提取并尝试自动关联资产与对白。',
    cancellingDescription: '已发送取消请求，系统会在当前步骤结束后停止，并在结束后自动刷新页面。',
    successDescription: '准备结果已刷新，候选内容已自动更新。',
    cancelledDescription: '准备结果刷新已取消。',
    failedDescription: '准备结果刷新失败，请稍后重试。',
    startedMessage: '已开始刷新准备结果',
    reusedMessage: '已恢复当前章节的准备结果刷新任务',
    cancelledImmediatelyMessage: '准备结果刷新已取消',
    cancelRequestedMessage: '已请求取消准备结果刷新',
    runningMessage: '当前已有准备结果刷新任务在运行',
    cancellingMessage: '当前准备结果刷新任务正在取消，请稍候',
  },
  consistencyCheck: {
    title: '一致性检查',
